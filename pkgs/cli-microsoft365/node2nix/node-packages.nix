...
let
  sources = {
    ...
    "@inquirer/confirm-3.1.5" = {
      ...
      version = "3.1.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@inquirer/confirm/-/confirm-3.1.5.tgz";
        sha512 = "6+dwZrpko5vr5EFEQmUbfBVhtu6IsnB8lQNsLHgO9S9fbfS5J6MuUj+NY0h98pPpYZXEazLR7qzypEDqVzf6aQ==";
      };
    };
    "@inquirer/core-8.0.1" = {
      ...
      version = "8.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@inquirer/core/-/core-8.0.1.tgz";
        sha512 = "qJRk1y51Os2ARc11Bg2N6uIwiQ9qBSrmZeuMonaQ/ntFpb4+VlcQ8Gl1TFH67mJLz3HA2nvuave0nbv6Lu8pbg==";
      };
    };
    ...
    "@inquirer/input-2.1.5" = {
      ...
      version = "2.1.5";
      src = fetchurl {
        url = "https://registry.npmjs.org/@inquirer/input/-/input-2.1.5.tgz";
        sha512 = "z4l1ISps86JZXo1OsWt8IAh4nnyXjXwcu/na2pKFkDud6DC9TLxvDPWxHmq25T40/WZCULhMQuCMDV+VccVG+A==";
      };
    };
    "@inquirer/select-2.3.1" = {
      ...
      version = "2.3.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@inquirer/select/-/select-2.3.1.tgz";
        sha512 = "UagbSdmSjeoukHLXqkDQi2ewiGEogUyxaOeKeH34Ngmc/2z+S8u4JsJWToMJNKIHjEtoTFdlYpFrxCxapp06nQ==";
      };
    };
    "@inquirer/type-1.3.0" = {
    ...
    "c8-9.1.0" = {
      ...
      src = fetchurl {
        ...
        sha512 = "mBWcT5iqNir1zIkzSPyI3NCR9EZCVI3WUD+AVO17MVWTSFNyUueXE82qTeampNtTr+ilN/5Ua3j24LgbCKjDVg==";
      };
    };
    ...
    eslint-plugin-cli-microsoft365-eslint-rules = {
      ...
      version = "1.0.0";
      src = ../../../../../../../../tmp/cli-microsoft365/eslint-rules;
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@inquirer/confirm-3.1.5"
      (sources."@inquirer/core-8.0.1" // {
        dependencies = [
          sources."chalk-4.1.2"
        ];
      })
      sources."@inquirer/figures-1.0.1"
      sources."@inquirer/input-2.1.5"
      (sources."@inquirer/select-2.3.1" // {
        dependencies = [
          sources."chalk-4.1.2"
        ];
      })
      ...
      sources."@typescript-eslint/eslint-plugin-7.7.1"
      sources."@typescript-eslint/parser-7.7.1"
      sources."@typescript-eslint/scope-manager-7.7.1"
      sources."@typescript-eslint/type-utils-7.7.1"
      sources."@typescript-eslint/types-7.7.1"
      (sources."@typescript-eslint/typescript-estree-7.7.1" // {
        dependencies = [
          sources."brace-expansion-2.0.1"
          sources."minimatch-9.0.4"
        ];
      })
      sources."@typescript-eslint/utils-7.7.1"
      sources."@typescript-eslint/visitor-keys-7.7.1"
